...
def update_progress():
    ...
    response.set_cookie("user_stats", updated_user_stats_json, max_age=31536000, httponly=True, secure=True, samesite="Lax")
    return response
...
def recommend_question():
    ...
    def recommendation_score(question):
        ...
        recency_score = question.get("recency_score", 0)  # Use 0 if recency_score is not present
        time_decay = 1.0
